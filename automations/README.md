...
```
automations/
├── slack_listener/     # Slack Events API listener
│   ├── index.js        # Express server
│   ├── lib/
│   │   ├── workflow_runner.js
│   │   └── slack_poster.js
│   └── package.json
├── triggers/           # Declarative event routing rules (future)
...
The Slack listener watches for `pmai run <workflow>` commands and executes workflows.
...
│   └── claude_prompt.md     # Prompt sent to Claude
├── artifacts/
